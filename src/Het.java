...
public class Het {
    ...
    private static List<Float> dataList = new ArrayList<>();
    ...
    static class HtmlHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            htmlBuilder.append("<html><head><title>Data Visualization</title>");
            htmlBuilder.append("<script src=\"https://cdn.jsdelivr.net/npm/chart.js\"></script>");
            htmlBuilder.append("</head><body>");
            htmlBuilder.append("<h1>Received Data</h1>");
    ...
    static class DataHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            if ("POST".equals(exchange.getRequestMethod())) {
                ...
                try {
                    convertedValue = Float.parseFloat(requestBody);
                } catch (Exception e) {
                    System.out.println("Incorrect type send, expected float");
                }

                // Store the received data
                synchronized (dataList) {
                    dataList.add(convertedValue);
                }
